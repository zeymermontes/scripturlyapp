...
class _VerseWidgetState extends State<VerseWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerseModel());
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: FlutterFlowTheme.of(context).baseSecondary,
        body: SafeArea(
          top: true,
          child: Column(
            ...
            children: [
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          FFLocalizations.of(context).getText(
                            '7vj1170l' /* For God so loved the world tha... */,
                          ),
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    context.pushNamed(ReadWidget.routeName);
                  },
                  text: FFLocalizations.of(context).getText(
                    '1bxkxvaj' /* Continue your path */,
                  ),
