...
class ResetPasswordCopyWidget extends StatefulWidget {
  ...
  static String routeName = 'resetPasswordCopy';
  static String routePath = '/resetPasswordCopy';
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'rw8dbdf9' /* We’ll send you an email with i... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
