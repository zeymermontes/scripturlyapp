...
import 'on_borad3_model.dart';
export 'on_borad3_model.dart';

class OnBorad3Widget extends StatefulWidget {
  const OnBorad3Widget({super.key});

  static String routeName = 'onBorad3';
  static String routePath = '/onBorad3';

  @override
  State<OnBorad3Widget> createState() => _OnBorad3WidgetState();
}

class _OnBorad3WidgetState extends State<OnBorad3Widget> {
  late OnBorad3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnBorad3Model());
                    ...
                    children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'vagi37dh' /* What brings you to Scripturly? */,
                              ),
                                  ...
                                  return InkWell(
                                    ...
                                    onTap: () async {
                                      if (_model.selectedOptions
                                        ...
                                        if (_model.selectedOptions.length < 5) {
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              context.pushNamed(OnBoradPathAWidget.routeName);
                            },
                            text: FFLocalizations.of(context).getText(
                              '9ex57teh' /* Skip this */,
                            ),
